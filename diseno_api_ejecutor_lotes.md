...
| `ejecutor` | Servicio de ejecución de lotes. Recibe solicitudes de ejecución, conecta ficheros y programas registrados, consulta estados de lotes, detiene lotes en ejecución y atiende operaciones de control del ejecutor. |
